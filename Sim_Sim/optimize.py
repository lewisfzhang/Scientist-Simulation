...
def greedy_investing(scientist, lock):
    ...
    while scientist.avail_effort > 0:
        ...
        increment = max(scientist.curr_k[scientist.avail_ideas]) + 1
        ...
        scientist.marginal_effort = increment - scientist.curr_k
        ...
        rel_age = int(scientist.current_age * 2 / input_file.time_periods_alive)  # halflife defines young vs old
    ...
    del no_effort_inv, scientist.curr_k, scientist.total_effort_start, increment, idea_choice, max_return, row_data,\
        row, temp_df, investing_queue
